            ...
            <Stack direction="row" gap="1rem" justifyContent="space-between">
              ...
              <Stack gap="1rem">
                ...
                <Typography variant="body1" textAlign="justify">
                  ...
                  достичь ваших спортивных целей. Мы предлагаем широкий спектр
                  услуг, включая тренажерный зал, групповые занятия и
                  персональные тренировки. Наша цель - создать комфортную
                  атмосферу для всех, кто стремится к здоровому образу жизни.
                  Здесь вы найдете поддержку и мотивацию, чтобы продвигаться
                  вперед и достигать новых высот. Присоединяйтесь к нам сегодня
                  и начните свой путь к здоровой и сильной фигуре! Мы с
